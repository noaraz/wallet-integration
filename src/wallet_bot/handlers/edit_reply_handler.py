...
from wallet_bot.handlers._render import label_for_attr, render_draft
...
async def handle_edit_reply(
    ...
    *,
    ...
    # Inline confirmation right where the user is looking — the in-place
    # edit happens far above the ForceReply prompt and is easy to miss.
    label = label_for_attr(field) or field
    await client.send_text(chat_id, f"✓ {label} updated.")
